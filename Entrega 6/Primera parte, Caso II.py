...
for k in range(int32(5./dt)):
    ...
    u_k[0,:] = 20 #con esto defino que no hay transito de calor por los extremos
    u_k[:,0] = 20 #con esto defino que no hay transito de calor por los extremos
    u_k[Nx,:] = 20 #con esto defino que no hay transito de calor por los extremos
    u_k[:,Nx] = u_ambiente(t,T)
...
#        savefig("frame_{}.png".format(framenum))
#        framenum += 1
#        next_t += dnext_t
#        close(1)
# 
