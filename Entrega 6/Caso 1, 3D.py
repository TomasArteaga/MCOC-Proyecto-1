# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 21:48:58 2019
...
pyplot.title("Puntos 1, 2, 3")
a = lagrange(Tiempo1, Temp1, "b")
b = lagrange(Tiempo2, Temp2, "g")
c = lagrange(Tiempo3, Temp3, "r")
print (a)
print (b)
print (c)
