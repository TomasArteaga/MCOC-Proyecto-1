...
a = 0.57        #Ancho del dominio
b = 1.          #Largo del dominio
c = 0.5         # Alto del dominio
Nx = 100        #Numero de intervalos en x
Ny = 57         #Numero de intervalos en Y
...
for k in range(int32(5./dt)):
    ...
    if k % 20 == 0:
        Temp1.append(u_km1[0, 28.5, 25])
        Tiempo1.append(t)
        
        Temp2.append(u_km1[25, 28.5, 25])
        Tiempo2.append(t)
        
        Temp3.append(u_km1[75, 28.5, 25])
        Tiempo3.append(t)
        
        Temp4.append(u_km1[100, 28.5, 25])
        Tiempo4.append(t)
        
        Temp5.append(u_km1[50, 28.5, 50])
        Tiempo5.append(t)
        
        Temp6.append(u_km1[50, 28.5, 37.5])
        Tiempo6.append(t)
        
        Temp7.append(u_km1[50, 28.5, 25])
        Tiempo7.append(t)
        
        Temp8.append(u_km1[50, 28.5, 12.5])
        Tiempo8.append(t)
        
        Temp9.append(u_km1[50, 28.5, 0])
        Tiempo9.append(t)
        
        Temp10.append(u_km1[50, 57, 25])
        Tiempo10.append(t)
        
        Temp11.append(u_km1[50, 42.75, 25])
        Tiempo11.append(t)
        
        Temp12.append(u_km1[50, 14.25, 25])
        Tiempo12.append(t)
        
        Temp13.append(u_km1[50, 0, 25])
        Tiempo13.append(t)
...
pyplot.plot(Tiempo10, Temp10)
pyplot.show()

pyplot.plot(Tiempo11, Temp11)
pyplot.show()

pyplot.plot(Tiempo12, Temp12)
pyplot.show()

pyplot.plot(Tiempo13, Temp13)
pyplot.show()
