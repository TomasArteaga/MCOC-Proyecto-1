...
#condición inicial
def fun_u0(x):
    return  5 + 10*exp(-(x-0.5)**2/0.1**2) #valor de partida para temperatura es de 5°c
...
u_k[n] =30.0 #temperatura en instante final (n) es 30°c
...
dt=1 #indica cuanto cambia el tiempo 
K=5.5
c=900.0
rho=2400.0
